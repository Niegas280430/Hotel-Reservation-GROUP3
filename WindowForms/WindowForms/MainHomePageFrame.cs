...
namespace WindowForms
{
    public partial class MainHomePageFrame : Form
    {
        ...
        {
            LoadUC_NORESERVATION(new UC_NO_RESERVATIONS());
        ...
        private void LoadUC<T>(T userControl) where T : UserControl
        {
            if (userControl is UC_HOME homeControl)
            {
                ...
                homeControl.viewRoomsClicked += (sender, e) => LoadUC_ROOMS(new UC_ROOMS());
            ...
            else if (userControl is UC_OFFERS offersControl)
            {
                ...
                offersControl.viewRoomsClicked += (sender, e) => LoadUC_ROOMS(new UC_ROOMS());
            ...
            {
                roomAvailability.Room1Clicked += (sender, e) =>
                {
                    LoadUC(new UC_BOOKING_CONFIRMATION2nd());
                };

                roomAvailability.Room2Clicked += (sender, e) =>
                {
                    LoadUC(new UC_BOOKING_CONFIRMATION2nd());
                };

                roomAvailability.Room3Clicked += (sender, e) =>
                {
                    LoadUC(new UC_BOOKING_CONFIRMATION2nd());
                };

                roomAvailability.Room4Clicked += (sender, e) =>
                {
                    LoadUC(new UC_BOOKING_CONFIRMATION2nd());
                };

                roomAvailability.Room5Clicked += (sender, e) =>
                {
                    LoadUC(new UC_BOOKING_CONFIRMATION2nd());
                };
            }
            ...
            {
                booking2nd.arrowClicked += (sender, e) =>
                {
                    LoadUC_ROOMS(new UC_ROOM_AVAILABILITY());
                };
            }
        ...
        private void LoadUC_ROOMS<T>(T userControl) where T : UserControl
        {
            ...
            {
                roomsControl.roomSearchClicked += (sender, e) => LoadUC_ROOMS(new UC_ROOM_AVAILABILITY());
            ...
            if (userControl is UC_STANDARD_ROOM standardRoomControl)
            {
                ...
                standardRoomControl.arrowClicked += (sender, e) =>
                {
                    LoadUC_ROOMS(new UC_ROOMS());
                };
            }
            ...
            if (userControl is UC_SINGLE_ROOM singleRoomControl)
            {
                ...
                singleRoomControl.arrowClicked += (sender, e) =>
                {
                    LoadUC_ROOMS(new UC_ROOMS());
                };
            }
            ...
            if (userControl is UC_TRIPLE_ROOM tripleRoomControl)
            {
                ...
                tripleRoomControl.arrowClicked += (sender, e) =>
                {
                    LoadUC_ROOMS(new UC_ROOMS());
                };
            }
            ...
            if (userControl is UC_SUITE_ROOM suiteRoomControl)
            {
                ...
                suiteRoomControl.arrowClicked += (sender, e) =>
                {
                    LoadUC_ROOMS(new UC_ROOMS());
                };
            }
            ...
            if (userControl is UC_DELUXE_ROOM deluxeRoomControl)
            {
                ...
                deluxeRoomControl.arrowClicked += (sender, e) =>
                {
                    LoadUC_ROOMS(new UC_ROOMS());
                };
            }
            ...
            {
                booking1st.arrowClicked += (sender, e) =>
                {
                    LoadUC_ROOMS(new UC_ROOMS());
                };
            }
        ...
        private void LoadUC_NORESERVATION<T>(T userControl) where T : UserControl
        {
            if (userControl is UC_NO_RESERVATIONS searchControl)
            {
                searchControl.searchClicked1 += (sender, e) => LoadUC_ROOMS(new UC_STANDARD_ROOM());
                searchControl.searchClicked2 += (sender, e) => LoadUC_ROOMS(new UC_SINGLE_ROOM());
                searchControl.searchClicked3 += (sender, e) => LoadUC_ROOMS(new UC_TRIPLE_ROOM());
                searchControl.searchClicked4 += (sender, e) => LoadUC_ROOMS(new UC_SUITE_ROOM());
                searchControl.searchClicked5 += (sender, e) => LoadUC_ROOMS(new UC_DELUXE_ROOM());
            }
