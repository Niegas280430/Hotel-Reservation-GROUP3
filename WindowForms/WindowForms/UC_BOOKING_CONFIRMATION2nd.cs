...
namespace WindowForms
{
    public partial class UC_BOOKING_CONFIRMATION2nd : UserControl
    {
        ...
        public UC_BOOKING_CONFIRMATION2nd()
        {
            ...
            lblTotalPrice1.Text = roomprice.ToString();
        }
        ...
        private void booknowBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand bookinginfo = new SqlCommand(
                    "INSERT INTO BookInfo (loginID, firstname, lastname, email, phone, checkin, checkout, RoomType) " +
                    "VALUES (@loginID, @firstname, @lastname, @email, @phone, @checkin, @checkout, @RoomType)",
                    con);
        ...
        private void setAdditionals()
        {
            ...
            // calculate total of home room price, and additionals with its quantity 
        ...
        private void btnAddChildren_Click_1(object sender, EventArgs e)
        {
            childrenguest--;
            if (childrenguest < 0)
            {
        ...
        private void btnSubAdult_Click_1(object sender, EventArgs e)
        {
                        adultsguest--;
            if (adultsguest < 0)
            {
